...
class PlaniantEvent {
  ...
  final String planiantEventOrganizerName;
  ...
  PlaniantEvent(
      ...
      this.planiantEventOrganizerName});
  ...
  factory PlaniantEvent.fromFirestore(DocumentSnapshot doc) {
    ...
    return PlaniantEvent(
        ...
        planiantEventOrganizerId:
            data['planiantEventOrganizerId'] ?? 'No OrganizerId',
        planiantEventOrganizerName:
            data['planiantEventOrganizerId'] ?? 'No OrganizerName');
  }
}
